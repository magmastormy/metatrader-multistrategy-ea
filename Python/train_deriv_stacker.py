...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Train a family-specific OOF ridge stacker for Deriv synthetic indices."
    )
    ...
    output = Path(args.output or f"{prefix}_stacker.pkl")
    ...
    print(f"Family: {prefix} ({args.family_id})")
