...
public:
    ...
    static CStrategyBase* CreateStrategy(ENUM_STRATEGY_TYPE type, const SStrategyConfig &config)
    {
        ...
        switch(type)
        {
            ...
            {
                CStrategyFibonacci* fibStrategy = new CStrategyFibonacci("Fibonacci", 1);
            ...
            {
                CStrategyElliott* elliottStrategyLocal = new CStrategyElliott();
                strategy = elliottStrategyLocal;
                break;
            }
